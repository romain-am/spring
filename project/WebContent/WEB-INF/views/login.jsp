...
<span class="login100-form-title p-b-32">
					...
					<div class="container-login100-form-btn">
						<div style="float:left; margin-right:90px"><input style="cursor: pointer" type="submit" formaction='perform_secure_login' name="submit" value="login" class="login100-form-btn"/></div>
						<div style="float:right"><input style="cursor: pointer" type="submit" formaction='register' name="submit" value="register" class="login100-form-btn"/></div>
					</div>

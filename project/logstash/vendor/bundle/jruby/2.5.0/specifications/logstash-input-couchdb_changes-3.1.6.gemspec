# -*- encoding: utf-8 -*-
# stub: logstash-input-couchdb_changes 3.1.6 ruby lib

Gem::Specification.new do |s|
  s.name = "logstash-input-couchdb_changes".freeze
  s.version = "3.1.6"
  ...
  s.summary = "Streams events from CouchDB's `_changes` URI".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<logstash-devutils>.freeze, [">= 0.0.6"])
      s.add_development_dependency(%q<logstash-output-elasticsearch>.freeze, [">= 0"])
    else
      ...
      s.add_dependency(%q<logstash-devutils>.freeze, [">= 0.0.6"])
